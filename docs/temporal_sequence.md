...
- **Type flexibility**: Values can be of any type supported by 4ever
...
The TEMPORAL_SEQUENCE type is registered with 4ever's custom type system, allowing it to be used seamlessly in 4ever scripts and programs:
