...
enum class TimelineEventType { SyncPoint, Pattern, Error, Recovery, Optimization };
...
struct TimelineEvent {
    ...
    TimelineEvent(TimelineEventType t, std::chrono::system_clock::time_point ts,
                  const std::string& desc, int seq = 0, double imp = 1.0)
