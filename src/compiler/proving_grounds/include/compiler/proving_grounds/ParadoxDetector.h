...
public:
   ...
   */
  std::vector<Paradox>
  detectParadoxes(const debugger::DejaVuDebugger &debugger) const;
...
private:
   ...
   */
  void
  detectVariableStateInconsistencies(const debugger::DejaVuDebugger &debugger,
                                     std::vector<Paradox> &paradoxes) const;
   ...
   */
  void
  detectThreadSynchronizationParadoxes(const debugger::DejaVuDebugger &debugger,
                                       std::vector<Paradox> &paradoxes) const;
};
