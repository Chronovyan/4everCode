 ...
 * which supports the complete language specification as defined in the Chronovyan
 * Language Guide (Act II Primer, Advanced Mechanics Addendum, and Reference Supplement).
 */
...
void printUsage(const std::string& programName) {
    ...
    std::cout << "======================" << std::endl;
    std::cout << "Usage: " << programName << " [options] <filename.cvy>" << std::endl;
    std::cout << std::endl;
    std::cout << "Options:" << std::endl;
    std::cout << "  --help                  Show this help message" << std::endl;
    std::cout << "  --verbose               Enable verbose output" << std::endl;
    std::cout << "  --no-visualize          Disable resource visualization" << std::endl;
    std::cout << "  --show-tokens           Show lexer tokens" << std::endl;
    std::cout << "  --show-ast              Show abstract syntax tree" << std::endl;
    std::cout << "  --debug                 Enable debug mode" << std::endl;
    std::cout << std::endl;
    std::cout << "Example:" << std::endl;
    std::cout << "  " << programName << " examples/01_beginner/01_hello_world.cvy" << std::endl;
}
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        if (verbose) {
            std::cout << "Source loaded successfully (" << source.length() << " bytes)"
                      << std::endl;
        }

        // Create lexer and tokenize the source
        // Modified to use proper constructor based on header definition
        // Note: SourceFile constructor takes an rvalue string, so we need to move 'source'
        ...
        if (verbose) {
            std::cout << "Execution complete (" << duration.count() << " ms)" << std::endl;
        ...
        if (visualizeResources) {
            ...
            // std::cout << "Aethel usage: " << interpreter.getTemporalRuntime()->getAethelUsage()
            // << std::endl; std::cout << "Chronon usage: " <<
            // interpreter.getTemporalRuntime()->getChrononsUsage() << std::endl; std::cout <<
            // "Temporal debt: " << interpreter.getTemporalDebtTracker()->getTotalDebt() <<
            // std::endl;

            std::cout << "\nResource Visualization:" << std::endl;
            // std::cout << interpreter.getResourceVisualization()->generateVisualization(60, 10) <<
            // std::endl;
        }
