...
constexpr const char* TOO_MANY_ARGUMENTS = "Cannot have more than 255 arguments";
constexpr const char* TOO_MANY_PARAMETERS = "Cannot have more than 255 parameters";
}  // namespace ErrorMessages
...
public:
    ...
    template <typename T>
    static std::unique_ptr<T> reportErrorAndSynchronize(DiagnosticReporter& reporter,
                                                        const Token& token,
