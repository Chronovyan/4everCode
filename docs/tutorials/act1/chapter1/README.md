...
- **Description:** Learn to interact with a 4ever sensor (the Whispering Stone) to gather atmospheric pressure readings
...
- **Link to example code:** [Sensor Reading Example](../../examples/01_beginner/act1_ch1_ex1_sensor_reading.4e)
...
- **Description:** Calibrate 4ever data crystals by understanding and converting between different data types
...
- **Link to example code:** [Environmental Data Translation](../../examples/01_beginner/act1_ch1_ex2_environmental_data_translation.4e)
...
- A basic understanding of how to interact with simple 4ever systems
