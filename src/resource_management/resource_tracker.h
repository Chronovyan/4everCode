...
// Data point structure to store resource measurements at a specific point in
// time
...
public:
  ...
  void recordCurrentUsage(double chronon_usage, double aethel_usage,
                          double temporal_debt = 0.0,
