---
title: Chronovyan Glossary of Terms
...
**Order (Conformity)** - The stabilizing force in Chronovyan that enables coherence, predictability, and reliable structure. Manifests in the form of `CONF` variables, `::STATIC` flags, and deterministic control structures.
...
**Weaving** - The act of programming in Chronovyan, particularly manipulating timelines and resources.
...
**Weaver** - A programmer who works with the Chronovyan language.
...
**Seeker** - A programmer who explores new applications and possibilities in Chronovyan.

**Archive Keeper** - A custodian of Chronovyan knowledge and documentation.

**First Weaver** - The legendary originator of the Chronovyan language.

## File and Document Types

**Core Wisdom Scrolls** - The fundamental documents explaining Chronovyan concepts.
...
2. **Variables**:
   - "A `CONF var` in Chronovyan maps to a variable with the `ORDER_ALIGNED` property in the implementation."
