...
bool Scope::addSymbol(const std::string& name, Symbol::Kind kind, const TypeNode* type,
                      bool initialized) {
...
bool SymbolTable::addSymbol(const std::string& name, Symbol::Kind kind, const TypeNode* type,
                            bool initialized) {
