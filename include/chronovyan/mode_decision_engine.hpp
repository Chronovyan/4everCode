...
public:
     ...
     */
    void setSourceRecoveryTestingState(bool had_previous_failure, bool cpu_failure,
                                       bool memory_failure) {
...
private:
    ...
    bool memory_was_unavailable_;  ///< Whether memory source was unavailable in the previous
                                   ///< evaluation
