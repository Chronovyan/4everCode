...
private:
     ...
     */
    void addInstruction(IROpCode opcode, const SourceLocation& location = SourceLocation());
     ...
     * @param location Source location of the instruction
     */
    void addInstruction(IROpCode opcode, const IRValue& operand1, const IRValue& operand2,
                        const SourceLocation& location = SourceLocation());
     ...
     */
    void startFunction(const std::string& name, const std::vector<std::string>& parameters = {});
