...
void BasicTypeNode::accept(AstVisitor &visitor) {
  visitor.visitBasicTypeNode(this);
}
...
void VariableExprNode::accept(AstVisitor &visitor) {
  visitor.visitVariableExprNode(this);
}
...
void ResourceStmtNode::accept(AstVisitor &visitor) {
  visitor.visitResourceStmtNode(this);
}

// Implementation of StmtDeclNode methods
void StmtDeclNode::accept(AstVisitor &visitor) {
  visitor.visitStmtDeclNode(this);
}
