...
enum class StabilityMetricType { Temporal, Resource, Performance, Error, Custom };
...
struct StabilityEvent {
    ...
    StabilityEvent(std::chrono::system_clock::time_point ts, StabilityMetricType t, double v,
