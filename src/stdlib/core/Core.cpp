...
BooleanPtr toBoolean(const ValuePtr& value) { return Boolean::create(isTruthy(value)); }
...
BooleanPtr isNumber(const ValuePtr& value) { return isType(value, Type::NUMBER); }
BooleanPtr isBoolean(const ValuePtr& value) { return isType(value, Type::BOOLEAN); }
BooleanPtr isString(const ValuePtr& value) { return isType(value, Type::STRING); }
BooleanPtr isArray(const ValuePtr& value) { return isType(value, Type::ARRAY); }
BooleanPtr isObject(const ValuePtr& value) { return isType(value, Type::OBJECT); }
BooleanPtr isFunction(const ValuePtr& value) { return isType(value, Type::FUNCTION); }
