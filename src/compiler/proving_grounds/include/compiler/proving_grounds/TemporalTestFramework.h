 ...
 * @brief Main framework class for testing temporal correctness in Chronovyan programs.
 *
 * The Temporal Proving Grounds provides a comprehensive testing environment for
 * temporal operations, including correctness testing, paradox detection, and benchmarking.
 */
class TemporalTestFramework {
public:
    /**
     ...
     * @return A vector of test results
     */
    std::vector<TemporalTestResult> runTestSuite(const std::string& testSuiteName);
     ...
     * @return A test case
     */
    std::shared_ptr<TemporalTestCase> createTestCaseFromBytecode(
     ...
     * @return A test case
     */
    std::shared_ptr<TemporalTestCase> createTestCaseFromSource(const std::string& sourceFilePath,
...
private:
     ...
     * @return The test result
     */
    TemporalTestResult runTestCase(const std::shared_ptr<TemporalTestCase>& testCase);
};
...
public:
     ...
     */
    TemporalTestResult(const std::string& testName, bool passed, const std::string& message = "");
...
public:
     ...
     */
    TemporalTestCase(const std::string& name, const bytecode::BytecodeModule& module);
...
public:
     ...
     */
    StateAssertion(const std::string& description, const std::string& variableName,
...
public:
     ...
     */
    ResourceAssertion(const std::string& description, const std::string& resourceName,
                      double expectedUsage, double tolerance = 0.0);
