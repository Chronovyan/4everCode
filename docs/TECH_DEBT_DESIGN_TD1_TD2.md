...
class ErrorForge {
public:
    static std::unique_ptr<4everError> forgeError(
...
void StateController::containError(const std::unique_ptr<4everError>& error) {
...
ModeDecision ModeDecisionEngine::craftErrorDecision(const 4everError* error) {
