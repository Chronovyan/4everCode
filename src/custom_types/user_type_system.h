...
public:
   ...
   * @return TypeBuilder& Reference to this builder for method chaining
   */
  TypeBuilder &withTemporalSupport(bool track_history = true,
                                   bool allow_time_travel = true);
...
public:
   ...
   */
  bool setInstanceField(const Value &instance, const std::string &field_name,
                        const Value &value);
