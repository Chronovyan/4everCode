...
public:
   ...
   * @return True if this type is compatible with the other type, false
   * otherwise
   */
...
/**
 * TypeChecker is responsible for performing type checking during semantic
 * analysis.
 */
class TypeChecker {
public:
   ...
   */
  Type checkBinaryOperation(TokenType op, const Type &leftType,
