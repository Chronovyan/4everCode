...
DebuggerState::DebuggerState()
    : instructionPointer(0), timelineId(0), threadId(0),
      potentialParadox(false) {}

DebuggerState::DebuggerState(const DebuggerState &other)
    : instructionPointer(other.instructionPointer), callStack(other.callStack),
      sourceLocation(other.sourceLocation),
      localVariables(other.localVariables),
      globalVariables(other.globalVariables),
      resourceUsage(other.resourceUsage), timelineId(other.timelineId),
      threadId(other.threadId), potentialParadox(other.potentialParadox) {}
...
void DebuggerState::setInstructionPointer(size_t ip) {
  instructionPointer = ip;
}

size_t DebuggerState::getInstructionPointer() const {
...
const std::vector<std::string> &DebuggerState::getCallStack() const {
  return callStack;
}
...
const SourceLocation &DebuggerState::getSourceLocation() const {
  return sourceLocation;
}

void DebuggerState::setLocalVariable(const std::string &name,
...
DebuggerState::getLocalVariables() const {
  return localVariables;
}

void DebuggerState::setGlobalVariable(const std::string &name,
                                      const std::string &value) {
  globalVariables[name] = value;
}

const std::map<std::string, std::string> &
DebuggerState::getGlobalVariables() const {
  return globalVariables;
}

void DebuggerState::setResourceUsage(const std::string &resource,
                                     double amount) {
  resourceUsage[resource] = amount;
}

std::map<std::string, double> DebuggerState::getResourceUsage() const {
...
void DebuggerState::setPotentialParadox(bool value) {
  potentialParadox = value;
}
