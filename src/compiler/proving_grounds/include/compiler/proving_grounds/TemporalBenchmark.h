 ...
 * temporal operations, including execution time, resource usage, and
 * efficiency.
 */
class TemporalBenchmark {
public:
  ...
  struct BenchmarkResult {
    ...
    std::map<std::string, double>
        efficiency; ///< Efficiency (output per unit of resource)
  };
...
private:
   ...
   */
  std::map<std::string, double>
  calculateAllEfficiencies(const std::string &operationName) const;
};
