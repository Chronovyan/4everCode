 ...
 *
 * This abstract class defines the interface for optimization passes in the Chronovyan compiler.
 * Each pass should implement the `run` method to perform specific optimizations on the AST.
 * Passes can be chained together to form an optimization pipeline.
 */
class OptimizationPass {
public:
