...
GraphicalResourceVisualizer::GraphicalResourceVisualizer(
    ...
    if (m_visualization) {
        // Note: In a real implementation, ResourceVisualization would have accessor methods
        // for these components. For now, we'll initialize them in the other constructor.
        m_runtime = nullptr;
        m_optimizer = nullptr;
...
GraphicalResourceVisualizer::GraphicalResourceVisualizer(
    std::shared_ptr<TemporalRuntime> runtime, std::shared_ptr<ResourceOptimizer> optimizer,
    ...
    m_visualization = std::make_shared<ResourceVisualization>(runtime, optimizer, debt_tracker);
...
std::string GraphicalResourceVisualizer::generateResourceChart(
    ...
    const ChartOptions& options, GraphOutputFormat output_format, const std::string& output_file) {
#ifdef CHRONOVYAN_NO_GRAPHICAL_VISUALIZATION
    return "Graphical visualization is not available. Matplot++ library was not found during "
           "build.";
#else
...
std::string GraphicalResourceVisualizer::generateDebtImpactChart(int projection_cycles,
                                                                 ChartType chart_type,
                                                                 const ChartOptions& options,
                                                                 GraphOutputFormat output_format,
...
std::string GraphicalResourceVisualizer::generateRebelOperationImpactChart(
    RebelOperationType operation_type, int projection_cycles, int operations_per_cycle,
    ChartType chart_type, const ChartOptions& options, GraphOutputFormat output_format,
    const std::string& output_file) {
#ifdef CHRONOVYAN_NO_GRAPHICAL_VISUALIZATION
    return "Graphical visualization is not available. Matplot++ library was not found during "
           "build.";
...
std::string GraphicalResourceVisualizer::generateResourceFlowDiagram(
    int history_length, const ChartOptions& options, GraphOutputFormat output_format,
    const std::string& output_file) {
#ifdef CHRONOVYAN_NO_GRAPHICAL_VISUALIZATION
    return "Graphical visualization is not available. Matplot++ library was not found during "
           "build.";
...
std::string GraphicalResourceVisualizer::generateCompleteDashboard(const ChartOptions& options,
                                                                   GraphOutputFormat output_format,
                                                                   const std::string& output_file) {
#ifdef CHRONOVYAN_NO_GRAPHICAL_VISUALIZATION
    return "Graphical visualization is not available. Matplot++ library was not found during "
...
std::string GraphicalResourceVisualizer::generateResourceTimeline(int history_length,
                                                                  const ChartOptions& options,
                                                                  GraphOutputFormat output_format,
                                                                  const std::string& output_file) {
#ifdef CHRONOVYAN_NO_GRAPHICAL_VISUALIZATION
...
#else
    // Full implementation that would use Matplot++
    return "Optimization opportunities chart would be generated here with Matplot++";
#endif
}

void GraphicalResourceVisualizer::setDefaultChartOptions(const ChartOptions& options) {
...
std::string GraphicalResourceVisualizer::getFileExtension(GraphOutputFormat format) {
    switch (format) {
