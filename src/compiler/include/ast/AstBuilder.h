...
public:
  ...
  createBinaryExpr(std::unique_ptr<ExpressionNode> left, const std::string &op,
   ...
   */
  std::unique_ptr<ExpressionNode>
  createCall(std::unique_ptr<ExpressionNode> callee,
  ...
  createVariableDecl(const std::string &name, const std::string &type,
   ...
   */
  std::unique_ptr<StatementNode>
  createBlock(std::vector<std::unique_ptr<StatementNode>> statements);
   ...
   */
  std::unique_ptr<StatementNode>
  createIf(std::unique_ptr<ExpressionNode> condition,
   ...
   */
  std::unique_ptr<StatementNode>
  createFor(std::unique_ptr<StatementNode> initializer,
   ...
   */
  std::unique_ptr<StatementNode>
  createWhile(std::unique_ptr<ExpressionNode> condition,
              std::unique_ptr<StatementNode> body);
   ...
   * @return A unique_ptr to the created statement node
   */
  std::unique_ptr<StatementNode> createFunctionDecl(
  ...
  createProgram(std::vector<std::unique_ptr<StatementNode>> statements);
