#ifndef CHRONOVYAN_COMPILER_DEBUGGER_DEJAVU_DEBUGGER_H
#define CHRONOVYAN_COMPILER_DEBUGGER_DEJAVU_DEBUGGER_H
...
struct BreakpointCondition {
    ...
    std::map<std::string, std::string> parameters;  // Additional parameters for the breakpoint
};
...
public:
    ...
    int setBreakpoint(const std::string& sourceFile, int line,
                      const BreakpointCondition& condition = {BreakpointType::LOCATION, "", {}});
     ...
     * @return The value of the variable as a string
     */
    std::string getVariableValueAt(const std::string& variableName, int historyIndex) const;
     ...
     */
    int registerBreakpointCallback(std::function<void(const DebuggerState&)> callback);
     ...
     * @param format The format of the visualization (e.g., "text", "json", "html")
...
private:
    ...
    std::unique_ptr<DebuggerState> currentState;       ///< Current state of the debugger
    ...
    std::unordered_map<int, std::function<void(const DebuggerState&)>> breakpointCallbacks;
...
public:
    DebuggerState();
    DebuggerState(const DebuggerState& other);
    DebuggerState& operator=(const DebuggerState& other);
    ...
    const std::map<std::string, std::string>& getLocalVariables() const;

    void setGlobalVariable(const std::string& name, const std::string& value);
    const std::map<std::string, std::string>& getGlobalVariables() const;

    void setResourceUsage(const std::string& resource, double amount);
...
public:
     ...
     */
    std::vector<std::string> getVariableHistory(const std::string& variableName) const;
...
private:
    ...
    std::map<std::string, std::vector<double>> resourceHistory;  ///< History of resource usage
    std::map<int, int>
        timelineBranching;  ///< Timeline branching history (timeline ID -> parent timeline ID)
...
private:
    ...
    std::map<int, Breakpoint> breakpoints;  ///< Map of breakpoint IDs to breakpoint information
     ...
     */
    bool evaluateCondition(const BreakpointCondition& condition, const DebuggerState& state) const;
};
...
public:
     ...
     * @return The visualization as a string
     */
    std::string visualizeState(const DebuggerState& state, const std::string& format) const;
     ...
     * @return The visualization as a string
     */
    std::string visualizeHistory(const StateHistory& history, const std::string& format) const;
     ...
     * @return The visualization as a string
     */
    std::string visualizeTemporalFlow(const StateHistory& history, const std::string& format) const;
...
private:
     ...
     * @return The visualization as a string
     */
    std::string generateTextHistoryVisualization(const StateHistory& history) const;
     ...
     * @return The visualization as a string
     */
    std::string generateJsonHistoryVisualization(const StateHistory& history) const;
     ...
     * @return The visualization as a string
     */
    std::string generateHtmlHistoryVisualization(const StateHistory& history) const;
     ...
     * @return The visualization as a string
     */
    std::string generateTextTemporalFlowVisualization(const StateHistory& history) const;
     ...
     * @return The visualization as a string
     */
    std::string generateJsonTemporalFlowVisualization(const StateHistory& history) const;
     ...
     * @return The visualization as a string
     */
    std::string generateHtmlTemporalFlowVisualization(const StateHistory& history) const;
};
...
#endif  // CHRONOVYAN_COMPILER_DEBUGGER_DEJAVU_DEBUGGER_H