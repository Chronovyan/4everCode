...
std::string CodeGenerator::getCTypeForBasicType(const std::string& chronovyanType) {
...
void CodeGenerator::visitParallelExecutionStmtNode(ParallelExecutionStmtNode* node) {
