...
// Use OpCode from BytecodeModule.h for compatibility
using OpCode = LegacyOpCode;
...
public:
  ...
  int getConstantIndex(const Constant &constant) {
    // This is a simplification - a real implementation would check if the
