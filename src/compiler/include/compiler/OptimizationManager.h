...
enum class OptimizationLevel {
    ...
    STANDARD,    ///< Standard optimizations (good balance between performance and compile time)
    AGGRESSIVE,  ///< Aggressive optimizations (may increase compilation time significantly)
    TEMPORAL     ///< Temporal-specific optimizations (focus on optimizing temporal operations)
};
...
public:
     ...
     * @param level The minimum optimization level at which to run this pass.
     */
    void registerTemporalPass(std::unique_ptr<OptimizationPass> pass,
     ...
     * @return True if the pass was found and its state was changed, false otherwise.
     */
